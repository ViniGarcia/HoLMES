...
#send POST /vnf/operation/<COVEN-VNF>/<post_package> {"package":"AlfaTesting Resources/Example.zip"}
#send POST /vnf/operation/<COVEN-VNF>/<post_install> {"package":"Example.zip"}
#send POST /vnf/operation/<COVEN-VNF>/<post_start> {}
#send GET /vnf/operation/<COVEN-VNF>/<get_list> {}
#send POST /vnf/operation/<COVEN-VNF>/<get_request> {"vnfc":"Forward.java", "request":"Packets", "args":"{}"}
