...
processFiles = [["COO", "Get-Status-COO-Direct.csv"], ["COO + EMS", "Get-Status-COO-EMS.csv"], ["Leaf", "Get-Status-Leaf-Direct.csv"], ["Leaf + EMS", "Get-Status-Leaf-EMS.csv"], ["COVEN (HTTP)", "Get-Status-COVENHTTP-Direct.csv"], ["COVEN (HTTP) + EMS", "Get-Status-COVENHTTP-EMS.csv"], ["COVEN (Socket)", "Get-Status-COVENSocket-Direct.csv"], ["COVEN (Socket) + EMS", "Get-Status-COVENSocket-EMS.csv"]]
...
makeHistogram(createIntervals(processFiles, 10, 250), 250, ['COO','COO + EMS', "Leaf", "Leaf + EMS", "COVEN (HTTP)", "COVEN (HTTP) + EMS", "COVEN (Socket)", "COVEN (Socket) + EMS"])
makeCDF(createCDFIntervals(createIntervals(processFiles, 10, 250), 120), 250, ['COO','COO + EMS', "Leaf", "Leaf + EMS", "COVEN (HTTP)", "COVEN (HTTP) + EMS", "COVEN (Socket)", "COVEN (Socket) + EMS"])