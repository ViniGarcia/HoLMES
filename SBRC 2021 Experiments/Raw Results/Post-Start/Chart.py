...
processFiles = [["COO", "Post-Start-COO-Direct.csv"], ["COO + EMS", "Post-Start-COO-EMS.csv"], ["Leaf", "Post-Start-Leaf-Direct.csv"], ["Leaf + EMS", "Post-Start-Leaf-EMS.csv"], ["COVEN (HTTP)", "Post-Start-COVENHTTP-Direct.csv"], ["COVEN (HTTP) + EMS", "Post-Start-COVENHTTP-EMS.csv"], ["COVEN (Socket)", "Post-Start-COVENSocket-Direct.csv"], ["COVEN (Socket) + EMS", "Post-Start-COVENSocket-EMS.csv"]]
...
makeHistogram(createIntervals(processFiles, 10, 3250), 3250, ['COO','COO + EMS', "Leaf", "Leaf + EMS", "COVEN (HTTP)", "COVEN (HTTP) + EMS", "COVEN (Socket)", "COVEN (Socket) + EMS"])
makeCDF(createCDFIntervals(createIntervals(processFiles, 10, 3250), 120), 3250, ['COO','COO + EMS', "Leaf", "Leaf + EMS", "COVEN (HTTP)", "COVEN (HTTP) + EMS", "COVEN (Socket)", "COVEN (Socket) + EMS"])