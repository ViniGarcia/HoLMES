...
<p align="justify"> HoLMES is also provided as a platform on the Ubuntu Cloud operating system. You can download the platform version <a href="https://drive.google.com/file/d/1fU1kpfbB4mfJ0WVKLuamHJYKDvrHrB0x/view?usp=sharing">HERE</a>. The virtual machine standard credentials are "user" for the username and "holmes" for the password. </p>
